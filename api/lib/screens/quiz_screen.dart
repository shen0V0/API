...
child: Text(option),
style: ElevatedButton.styleFrom(backgroundColor: const Color.fromARGB(255, 235, 238, 240)),
);
}
@override
...
children: [
Text(
'Question ${_currentQuestionIndex + 1}/${_questions.length}', style: TextStyle(fontSize: 20),),
SizedBox(height: 16),
Text(
question.question,
